...
public final class ItemNeutroniumPickaxe {
    ...
    }.setRegistryName("astrotweaks", "neutronium_pickaxe").setUnlocalizedName("neutronium_pickaxe").setCreativeTab(astrotweaks.creativetab.ATCreativeTabs.ASTRO_TWEAKS_CT);
