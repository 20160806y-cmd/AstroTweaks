...
public final class ItemNeutroniumShovel {
    ...
    }.setRegistryName("astrotweaks", "neutronium_shovel").setUnlocalizedName("neutronium_shovel").setCreativeTab(astrotweaks.creativetab.ATCreativeTabs.ASTRO_TWEAKS_CT);
