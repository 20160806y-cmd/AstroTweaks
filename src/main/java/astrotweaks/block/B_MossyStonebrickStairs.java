...
public class B_MossyStonebrickStairs {
	public static final Block block = new BlockCustom().setRegistryName("astrotweaks", "mossy_stonebrick_stairs");
	public static class BlockCustom extends BlockStairs {
		public BlockCustom() {
			super(new Block(Material.ROCK).getDefaultState());
			setUnlocalizedName("mossy_stonebrick_stairs");
