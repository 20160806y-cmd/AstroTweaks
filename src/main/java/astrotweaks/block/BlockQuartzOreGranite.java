...
public class BlockQuartzOreGranite {
	...
	private static final com.google.common.base.Predicate<IBlockState> GRANITE_MATCH = state -> state != null && state.getBlock() == Blocks.STONE && state.getBlock().getMetaFromState(state) == 1;
