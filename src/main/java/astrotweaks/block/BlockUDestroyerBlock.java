...
public class BlockUDestroyerBlock {
	...
	public static class BlockCustom extends Block {
		...
		@Override public boolean onBlockActivated(World world, BlockPos pos, IBlockState state, EntityPlayer entity, EnumHand hand, EnumFacing direction, float hitX, float hitY, float hitZ) {
