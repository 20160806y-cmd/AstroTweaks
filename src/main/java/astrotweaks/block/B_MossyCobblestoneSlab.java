...
public class B_MossyCobblestoneSlab {
	public static final Block block = new BlockCustom().setRegistryName("astrotweaks", "mossy_cobblestone_slab");
	public static final Block block_slab_double = new BlockCustom.Double().setRegistryName("astrotweaks", "mossy_cobblestone_slab_double");
	public static class BlockCustom extends BlockSlab {
		public BlockCustom() {
			super(Material.ROCK);
			setUnlocalizedName("mossy_cobblestone_slab");
