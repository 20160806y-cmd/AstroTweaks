...
public class BlockGroundRock2 {
	...
	public static class BlockCustom extends Block {
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if ((((world.getBlockState(new BlockPos(x, y, z))).getBlock() == BlockGroundRock2.block.getDefaultState().getBlock())
					&& ((world.getBlockState(new BlockPos(x, y - 1, z))).getBlock() == Blocks.AIR.getDefaultState().getBlock()))) {
				world.setBlockToAir(new BlockPos(x, y, z));

				EntityItem entityToSpawn = new EntityItem(world, (x + 0.5), (y + 0.5), (z + 0.5), new ItemStack(ATItems.ROCK_FLAT, 1));
