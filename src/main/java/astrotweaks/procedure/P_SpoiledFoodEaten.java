...
public final class P_SpoiledFoodEaten {
	...
	public static void exect(Entity entity) {
		...
		if (((RandInt) < 0.5)) {
				((EntityLivingBase) entity).addPotionEffect(new PotionEffect(MobEffects.HUNGER, (int) 2400, (int) 2, (false), (false)));
		...
		if (((RandInt) < 0.25)) {
				((EntityLivingBase) entity).addPotionEffect(new PotionEffect(MobEffects.HUNGER, (int) 3000, (int) 3, (false), (false)));
		...
		if (((RandInt) < 0.1)) {
				((EntityLivingBase) entity).addPotionEffect(new PotionEffect(MobEffects.HUNGER, (int) 3000, (int) 5, (false), (false)));
				((EntityLivingBase) entity).addPotionEffect(new PotionEffect(MobEffects.MINING_FATIGUE, (int) 2400, (int) 2, (false), (false)));
				((EntityLivingBase) entity).addPotionEffect(new PotionEffect(MobEffects.POISON, (int) 1200, (int) 3, (false), (false)));
